...
let mission4 = {
    ...
    steps: [
        ...
        },
        {
            ...
            end_blocks: ['tutor_mission', 'tutor_menu_mission', 'event_whenflagclicked', 'control_if'],
            init: {
        ...
        {
            init_blocks: ['tutor_mission', 'tutor_menu_mission', 'event_whenflagclicked', 'control_if'],
            end_blocks: ['tutor_mission', 'tutor_menu_mission', 'event_whenflagclicked', 'control_if', 'sensing_mousedown'],
            init: {
        ...
        {
            init_blocks: ['tutor_mission', 'tutor_menu_mission', 'event_whenflagclicked', 'control_if', 'sensing_mousedown'],
            end_blocks: ['tutor_mission', 'tutor_menu_mission', 'event_whenflagclicked', 'control_if', 'sensing_mousedown', 'sound_playuntildone', 'sound_sounds_menu'],
            init: {
