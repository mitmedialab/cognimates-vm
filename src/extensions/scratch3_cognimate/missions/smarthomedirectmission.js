...
let smarthomedirectmission = {
    ...
    steps:[
        ...
        },
        {
            ...
            init: {
                text: "We always want our lights to be waiting for our commands. So let's make sure to wrap everything with a forever loop under controls."
            },
            ok: {
                text: "Great job!"
            },
        ...
        },
        {
            ...
            init: {
                text: "Now write your smart home a message and save it in an answer variable. You should use the Ask and Wait block under sensing."
            },
            ok: {
                text: "Awesome!"
            },
        ...
        },
        {
            ...
            init: {
                text: "The smart lights should turn on depending on what your command is. Let's start by placing using an empty if block."
            },
            ok: {
                text: "Great job!"
            },
        ...
        },
        {
            ...
            init: {
                text: "Now we want to see if the smart lights think our message means lights on. For that, put a green equals block into the if block."
            },
            ok: {
        ...
        },
        {
            ...
            init: {
                text: "Using your trained Watson model, you want to see if the smart lights recognize your command as lights on. You can find the recognize text block under the Watson extension."
            },
            ok: {
                text: "Great job! Let's move on."
            },
            bad_block: {
                text: "Those aren't the right blocks. Make sure you're using your answer variable, the Watson recognize text block, and filling in the other side of the equals operator."
            }
        },
        {
            ...
            init: {
                text: "If your model recognizes your command to mean lights on, we can have the smart lights turn on. Nest the Set light status to On block under the if block."
            },
            ok: {
